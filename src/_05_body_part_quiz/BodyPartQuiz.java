...
for(int i=0; i<4; i++) {
		...
		if (guess.equalsIgnoreCase("arnold")&& i==0) {
			JOptionPane.showMessageDialog(null, "correct");
			score += 1;
		}
		
		else if (guess.equalsIgnoreCase("leonardo")&& i==1){
			JOptionPane.showMessageDialog(null, "correct");
		}
		
		else if (guess.equalsIgnoreCase("morgan")&& i==2) {
			JOptionPane.showMessageDialog(null, "correct");
		}
		
		else if(guess.equalsIgnoreCase("jack")&& i==3) {
			JOptionPane.showMessageDialog(null, "correct");
		}
		// 6. Otherwise:
		// -- Tell them they are wrong and who the person is
			...
			String person = "";
			if(i==0) {person = "arnold";}
			if(i==1) {person = "leonardo";}
			if(i==2) {person = "morgan";}
			if(i==3) {person = "jack";}
			JOptionPane.showMessageDialog(null, "Wrong, it is " + person );
			score -= 1;
		}
